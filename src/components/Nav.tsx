...
const Nav = () => {
  ...
  return (
    <>
      <MobileHeader>
        <Title>Sadaath Foundation</Title>
        {openOnMobile ? (
      ...
      <Container openOnMobile={openOnMobile}>
        ...
        <Items>
          {!openOnMobile ? (
            <Row>
              <Title>Saadath Foundation</Title>
              {/* <IconButton>
              <ChevronDown />
            </IconButton> */}
            </Row>
          ...
          <Row>
            <Location
              target="_blank"
              href={doing ? `https://www.google.com/maps/search/Chicago%2C%20IL` : undefined}
              rel="noreferrer"
             >
              <NavigationIcon />
              {doing?.kv.location ? (
          ...
          <div ref={dragConstraintsRef}>
            ...
            <Page active={pathname === '/work' ? 1 : 0} to="/work">
              Our Work
            </Page>
            <Page active={pathname === '/donate' ? 1 : 0} to="/donate">
              Donate
            </Page>
